    ...
    <div className='flex gap-2 items-center'>
      <DropdownMenu>
        <DropdownMenuTrigger className='header-button' asChild>
          {session ? (
            // 로그인 상태일 때
            <div className='w-full px-2 py-1 pr-3 bg-background rounded-full flex items-center justify-center ring ring-gray-300/20 hover:bg-red-50 bg-mainBg cursor-pointer'>
              <div>
                <Image
            ...
            // 비로그인 상태일 때
            <div className='w-9 h-9 bg-background rounded-full flex items-center justify-center ring ring-gray-300/20 hover:bg-red-50 bg-mainBg cursor-pointer'>
              <Gi3dGlasses size='20' />
            </div>
          )}
        </DropdownMenuTrigger>
